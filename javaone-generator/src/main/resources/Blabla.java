...
public class Blabla {
    ...
    /**
     * Nothing new here, just a main method that parses some Java code and prints it out again.
     *
     * @param buf
     * @param opcode
     */
                                                        ...
                                                        if (opcode >= 35 && opcode < 40)
                                                            ...
                                                            if (opcode == 42) {
                                                                ...
                                                                for (int i_51_ = 0; (i_51_ < i_50_); i_51_++)
                                                                    aByteArray1501[i_51_] = (buf.readByte(false));
                                                            } else if (opcode != 65) {
                                                                if (opcode == 78)
                                                                                                        ...
                                                                                                        if (opcode == 125) {
                                                                                                            ...
                                                                                                            if (opcode == 129) {
                                                                                                                ...
                                                                                                                for (int i_57_ = 0; i_56_ > i_57_; i_57_++)
                                                                                                                    ((Class94) this).anIntArray1441[i_57_] = buf.readUnsignedShort();
                                                                                                            }
                                                                                                        } else {
